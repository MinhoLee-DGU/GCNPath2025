...
def main():
    ...
    if args.dir_test is not None and args.dir_param is not None :
        ...
        args = create_dir_out_(args, suf_param="pth")
    ...
    # dir_drug = rpath+'_data/drug_feature_graph.npy'
    ...
    if args.mode=="train" and not args.sim :
        ...
        ic50_test = ic50_data
        test_loader = load_data_test(ic50_test, drug_data, cell_data, edge_index, args)
        ...
        raise Exception("The code is not prepared yet... [no pretrained weight]")
