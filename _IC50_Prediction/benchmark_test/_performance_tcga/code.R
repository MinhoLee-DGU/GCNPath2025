...
# main = sprintf("%s/Tumor vs Normal", dir)
# Summary_List_TN %>% boxplot_tn_total(main=main, save=T)
...
# 1 Fluorouracil 7.424507e-10 -0.09107917
# 2  Gemcitabine 7.858965e-06 -0.33101650
# 3  Carboplatin 2.648859e-03 -0.10113298
# 
# [1] "# HiDRA"
...
# [1] "# PaccMann_SG"
# Drug_Name        Pval Effect_Size
# 1 Fluorouracil 0.007551317  -0.3628428
# 2    Sorafenib 0.015906744  -0.6011390
# 
# [1] "# TGDRP"
# Drug_Name         Pval Effect_Size
# 1 Fluorouracil 0.0001222628   -0.168496
# 
# [1] "# TGDRP_SG"
# Drug_Name        Pval Effect_Size
# 1  Gemcitabine 0.003637741 -0.24138801
# 2 Fluorouracil 0.023102120 -0.06989234
# 
# [1] "# DRPreter"
# Drug_Name         Pval Effect_Size
# 1 Fluorouracil 1.598162e-07  -0.4231562
# 2  Gemcitabine 6.520976e-03  -0.2892494
# 3  Carboplatin 1.074086e-02  -0.3192893
# 
# [1] "# DRPreter_SG"
# Drug_Name         Pval Effect_Size
# 1 Fluorouracil 1.345624e-05  -0.3402699
# 2  Gemcitabine 4.758517e-04  -0.3657159
# 
# [1] "# GCNPath"
# Drug_Name         Pval Effect_Size
# 1 Fluorouracil 6.305972e-15 -0.57411102
# 2 Temozolomide 1.314260e-07 -0.07832652
# 3    Sorafenib 4.902823e-04 -0.21181322
# 4    Cisplatin 1.166561e-02 -0.15044640
# 5  Gemcitabine 1.496422e-02 -0.22941754
