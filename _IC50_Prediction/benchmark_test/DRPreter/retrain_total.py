...
def main():
    ...
    if args.dir_test is not None and args.dir_param is not None :
        ...
        args.dir_valid = "{}/pred_total_seed{}.csv".format(args.dir_out, args.seed)
    ...
    if args.mode=="train" and not args.sim :
        train_loader = load_data_test(ic50_data, drug_data, cell_data, edge_index, args, shuffle=True)
...
# -----------------------------------------------------------------
    ...
    if args.mode == 'train':
        ...
        results_path = args.dir_out + "/results_retrain_seed{}.txt".format(args.seed)
        # results_path = args.dir_out + "/results_{}.txt".format(nth)
        ...
        for epoch in range(1, args.epochs + 1):
            ...
            torch.save({'model_state_dict': model.state_dict()}, args.dir_param)
        ...
        train_MSE, train_RMSE, train_MAE, train_PCC, train_SCC, pred_train = validate(model, train_loader, args)
        ...
        pred_to_csv(pred_train, ic50_data, dir_pred=args.dir_valid)
