...
def arg_parse():
    ...
    parser.add_argument('--epochs', type=int, default=100, help='maximum number of epochs (default: 300)')
...
def main():
    ...
    if args.mode=="train" :
        train_data = MyDataset(drug_data, cell_data, ic50_data, edge_index, args)
        ...
        test_data = MyDataset(drug_data, cell_data, ic50_data, edge_index, args)
        test_loader = DataLoader(test_data, batch_size=args.batch_size, shuffle=False, collate_fn=collate_fn, num_workers=args.cpu)
    ...
    if args.mode == 'train':
        ...
        train_rmse, train_MAE, train_r2, train_r, pred_train = validate(model, train_loader, args.device)
