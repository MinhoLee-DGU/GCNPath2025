...
def ic50_split_path_lite(args, ic50_train, ic50_valid, ic50_test, dir_ic50=None) :
    ...
    args.dir_train_temp = "{}/{}_{}_{}_{}_Train.csv".format(dir_ic50, dir1, dir2, dir3, args.nth)
    args.dir_valid_temp = "{}/{}_{}_{}_{}_Valid.csv".format(dir_ic50, dir1, dir2, dir3, args.nth)
    args.dir_test_temp = "{}/{}_{}_{}_{}_Test.csv".format(dir_ic50, dir1, dir2, dir3, args.nth)
...
def ic50_split_path_seed(args, ic50_train, ic50_valid, ic50_test, dir_ic50=None) :
    ...
    args.dir_train_temp = "{}/{}_{}_{}_Seed{}_Train.csv".format(dir_ic50, dir1, dir2, args.nth, args.seed)
    args.dir_valid_temp = "{}/{}_{}_{}_Seed{}_Valid.csv".format(dir_ic50, dir1, dir2, args.nth, args.seed)
    args.dir_test_temp = "{}/{}_{}_{}_Seed{}_Test.csv".format(dir_ic50, dir1, dir2, args.nth, args.seed)
