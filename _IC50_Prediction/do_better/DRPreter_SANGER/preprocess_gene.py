...
if __name__ == '__main__':
    ...
    save_cell_graph(genes_path, save_path="./_data")
    
    
    # EXP for Similarity Graph
    import pickle
    file1 = os.path.join(gene_path, 'EXP.csv')
    file2 = os.path.join(gene_path, 'EXP_Total_Scaled.csv')
    ...
    with open("./_data/cell_feature_normalized", "wb") as f : 
