...
expression_df=pd.read_csv('./_data/sanger1018_brainarray_ensemblgene_rma.txt',sep='\t',index_col=0)
...
geneset_before = list(set(i) for i in GeneSet_Dic.values())
print("# of Genes : {}".format(len(set.union(*geneset_before))))
...
geneset_after = list(set(i) for i in GeneSet_Dic_withoutNA.values())
print("# of Genes : {}".format(len(set.union(*geneset_after))))
