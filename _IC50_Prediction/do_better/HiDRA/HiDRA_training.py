...
def main():
    ...
    dir_ic50 = "./_data"
    args = create_dir_out(args, suf_param="h5")
    ...
    history = model.fit_generator(train_loader, validation_data=valid_loader, 
                                  steps_per_epoch=steps_train, validation_steps=steps_valid, 
