...
def main(modeling, train_batch, val_batch, test_batch, lr, num_epoch, log_interval, args) :
    ...
    ic50 = args.ic50
    choice = args.choice
    args = create_dir_out_(args, suf_param="pt")
...
if __name__ == "__main__":
    ...
    main(modeling, train_batch, val_batch, test_batch, lr, num_epoch, log_interval, args)
