...
def main():
    ...
    if args.dir_test is not None and args.dir_param is not None :
        ...
        args.weight_tgdrp = "Results/IC50_GDSC/Normal/TGDRP/param_retrain_seed{}.pth".format(args.seed)
        args.weight_tgsa = args.dir_param
    ...
    if args.mode=="train" :
        train_data = MyDataset_SA(drug_name2idx, cell_name2idx, ic50_data, args)
        ...
        test_data = MyDataset_SA(drug_name2idx, cell_name2idx, ic50_data, args)
        test_loader = DataLoader(test_data, batch_size=args.batch_size, shuffle=False, num_workers=args.cpu)
