...
test_loader = load_data(ic50_data, cell_data, drug_data, args, no_labels, batch_size, num_workers, shuffle=False)
...
pred_test = test_(model, test_loader, device=device, return_attn=False)
